...
function insertData($conn, $id_cliente, $tipo_atendimento, $tecnico, $node, $cto, $portas_livres, $sinal, $feito_via, $obs, $data, $cidade, $atendente, $item_id) {
    ...
    $stmt->bind_param("sssssssssssss", $id_cliente, $tipo_atendimento, $tecnico, $node, $cto, $portas_livres, $sinal, $feito_via, $obs, $data, $cidade, $atendente, $item_id);
  ...
  $item_id = isset($_POST['item_id']) ? htmlspecialchars($_POST['item_id']) : '';
